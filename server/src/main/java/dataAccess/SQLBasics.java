...
public class SQLBasics {   public SQLBasics() throws DataAccessException {
    //configureDatabase();
}
    ...
    public Pet getPet(int id, String table) throws DataAccessException {
        try (var conn = DatabaseManager.getConnection()) {
            String StatementBuilder = "SELECT id, json FROM " + table + " WHERE id=?";
