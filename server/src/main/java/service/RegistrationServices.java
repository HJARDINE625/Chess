...
public class RegistrationServices {
    public Responses register(UserData user, DataAccesser myDatabase){
        ...
        try {
            ...
            //we add the below in order to make sure that we can catch database errors...
    ...
    public Responses login(String username, String password, DataAccesser myDatabase){
        ...
        try {
            ...
            //we could not access the database at some point
        } catch (DataAccessException e){
            Responses faliureResponse = new Responses(500);
            faliureResponse.setMyException(e);
            return faliureResponse;
    ...
    public Responses logout(String authentication, DataAccesser myDatabase){
        ...
        try {
            ...
            //this should make sure that if the database threw an error it still does not matter to the logic...
        } catch (DataAccessException e){
            Responses faliureResponse = new Responses(500);
            faliureResponse.setMyException(e);
            return faliureResponse;
